...
<div class="w3-top">
  <ul class="w3-navbar w3-white w3-card-2" id="myNavbar">
    ...
    <li class="w3-right w3-hide-small">
      ...
      <a href="#team"><i class="fa fa-user"></i> EQUIPO</a>
      <a href="#portfolio"><i class="fa fa-th"></i> PORTAFOLIO</a>
      <a href="#pricing"><i class="fa fa-usd"></i> PRECIO</a>
      <a href="#contact"><i class="fa fa-envelope"></i> CONTACTANOS</a>
    </li>
...
<nav class="w3-sidenav w3-black w3-card-2 w3-animate-left w3-hide-medium w3-hide-large" style="display:none" id="mySidenav">
  ...
  <a href="#portfolio" onclick="w3_close()">WORK</a>
  ...
  <div id="id01" class="w3-modal">
    <div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:600px">
      ...
      <div class="w3-center"><br>
        ...
        <img src="http://www.w3schools.com/w3images/avatar2.png" alt="Avatar" style="width:30%" class="w3-circle w3-margin-top">
      </div>

      <form class="w3-container" action="template.php">
        <div class="w3-section">
          <label><b>Nombre</b></label>
          <input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="Introduzca su Nombre" name="nombre" required>
